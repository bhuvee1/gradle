...
public class EmployeeController {
    ...
    public Optional<Employee> getAllEmployeesById(@PathVariable(value="id")Integer id)
    {
    ...
    public @Valid Employee updateEmployeesById(@PathVariable(value="id")Integer id, @Valid @RequestBody Employee employee)
